function evenNum(){
    ...
    if (num1 <= 2 || num1 >= 100){
        document.getElementById("msg1").innerHTML = "Number 1 input " + num1 + " is not in the range of 2 and 100.";
    ...
    if (num2 <= 2 || num2 >= 100){
        document.getElementById("msg2").innerHTML = "Number 1 input " + num2 + " is not in the range of 2 and 100.";
        document.getElementById("result").innerHTML = "";
